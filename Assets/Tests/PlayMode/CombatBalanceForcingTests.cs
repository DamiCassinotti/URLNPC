...
// The balance only holds if it survives deserialization — the FPS scene pins
// the weapon damage where no text edit reaches it — so this fires a real
// EnemyWeapon and checks what the victim actually lost (issue #71).
